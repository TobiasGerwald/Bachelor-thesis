...
savefig("C:\\Users\\Tobias\\Korrelationen")
...
function parametersample(parms, p)
    ...
    unif = 2 * rand(length(parms) ) .- 1  #rand() erzeugt unif(0,1) -> erhalte 15 uniform(-1,1) verteilte Proben
...
df = CSV.File("C:\\Users\\Tobias\\Documents\\RKI_COVID19.csv") #Stand 19.07.2020 ; !!! Speicherort der Datei hier mit doppel // angeben !!!
...
"posterior"
sqrtΓinv = inv(Diagonal(sqrt.(0.05*truedata)))
